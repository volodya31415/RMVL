...
#' The MVL file directory is updated to include recently added entries. 
#'
#'
#' \code{mvl_open} returns a handle with updated directory. Old handles can still be used, but will not include update directory information.
#'
